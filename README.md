...
It scans on enable/session startup and every 60 seconds, so new Steam shortcuts
are picked up automatically. No bar widget, API key, or network access.
...
- Leaves games without cached artwork alone and retries on the next scan.
